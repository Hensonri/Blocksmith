...
const WORKFLOW = ["Capture", "Design", "Prepare", "Print", "Use", "Verify", "Preserve"];
...
export function App() {
  ...
  function renderLeftPanel() {
    ...
    return (
      <>
        <h2>Preserve the Work</h2><p className="panel-intro">Keep the editable Hat Project with the print, inspection, and material history.</p>
